...
public abstract class AbstractRequest extends AbstractWebUtils {
    ...
    protected static int SO_CONNECT_TIMEOUT = 10000;//10 SECONDS
     ...
     * @param httpMethod
     */
    public AbstractRequest(String url, List<Header> headers, Map<String, String> parameters,HttpMethod httpMethod) {
     ...
     */
    public AbstractRequest(String url, List<Header> headers, Map<String, String> parameters,Map<String, FileItem> attachments,
    							HttpMethod httpMethod, Callback callback, Object requestFlag) {
    ...
    /**
     * 发起同步api调用<br/>
     * 如果request对象中设置了callback对象。在此方法返回前{@link Callback#onCompleted(Response, Object)}方法将被同步回调，<br>
    ...
    public Response execute() {
        ...
        try {
            ...
            Log.e(sTAG, "exception: "+e1.getMessage());
            if (response == null) {
                response = Response.fromError(e1, null);
            } else {
                response.setRequestError(new RequestError(e1, null));
            }
        }
        ...
        if (this.callback != null) {
            ...
            if (callbackHandler == null) {
                // Run on this thread.
                req.getCallback().onCompleted(resp, req.getRequestFlag());
            } else {
                // Post to the handler.
    ...
    public interface Callback {
        void onCompleted(Response response, Object requestFlag);
    }
}
